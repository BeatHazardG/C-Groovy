...
const songs = [
    {
      ...
      name: "Autumn",
      artist: "NIKI",
      description: "Lagu ini menggambarkan kompleksitas hubungan romantis yang sempat memburuk.",
      lyrics: `I carved my name into your ribcage
...
Maybe we've had enough`,
      audio: "../assets/autumnSong.mp3" 
    },
    {
      id: 2,
      name: "In The Star",
      image : "../assets/inthestar.jpeg",
      artist: "Benson Boone",
      description: "Lagu ini menceritakan tentang kehilangan seorang sosok istimewa yang sangat penting dalam hidupnya.",
      lyrics: `Two, three
...
Left the rest in pieces`,
      audio: "../assets/audioInTheStar.mp3"
    },
    {
      id: 3,
      image : "../assets/takditanganku.jpeg",
      name: "Tak di Tanganku",
      artist: "Juicy Luicy & Mawar de Jongh",
      description: "Lagu ini menceritakan tentang tantangan dan kesulitan dalam hubungan jarak jauh.",
      lyrics: `Malam kita sudah beda
...
Dimimpi kita bertemu`,
      audio: "../assets/audioTakDiTanganku.mp3"
    },
    {
      id: 4,
      name: "Blue",
      ...
      artist: "Yung Kai",
      description: "Lagu ini menceritakan tentang perasaan cinta yang tulus, harapan, dan keyakinan.",
...
So let me fly with you
Will you be forever with me?`,
      audio: "../assets/audioBlue.mp3"
    },
    {
      id: 5,
      name: "Promise",
      image: "../assets/promise.jpeg",
      artist: "Laufey",
      description: "Lagu ini menggambarkan pergulatan batin seseorang yang gagal move on dari masa lalu.",
      lyrics: `I made a promise
To distance myself
...
It's worse to be nothing
With you`,
      audio: "../assets/audioPromise.mp3"
    },
    {
      id: 6,
      name: "Die With a Smile",
      image:"../assets/diewithasmile.jpeg",
      artist: "Lady Gaga & Bruno Mars",
      description: "Lagu ini menggambarkan keinginan untuk menghabiskan saat-saat terakhir dengan pasangan meskipun dunia berakhir.",
      lyrics: `Ooh
...
I'd wanna be next to you`,
      audio: "../assets/audioDieWithaSmile.mp3"
    },
    {
      id: 7,
      name: "Snooze",
      image:"../assets/snooze.jpeg",
      artist: "SZA",
      description: "Lagu ini menceritakan tentang kerinduan dan keinginan untuk kembali bersatu dengan pasangan.",
      lyrics: `Ooh
I think I know
...
I think I know, ooh-woah, ooh-woah, oh, oh`,
      audio: "../assets/audioSnooze.mp3"
    },
    {
      id: 8,
      name: "Bad Habit",
      image:"assets/badhabit.jpeg",
      artist: "Steve Lacy",
      description: "Lagu ini menceritakan tentang kebiasaan buruk, seperti yang sering dilakukan oleh penyanyi.",
      lyrics: `wanted me
...
You'll miss me, don't beg me, babe`,
      audio: "../assets/audioBadHabit.mp3"
    },
    {
      id: 9,
      name: "Passionfruit",
      image:"../assets/passionfruit.jpeg",
      artist: "Drake",
      description: "Lagu ini menceritakan bukti kompleksitas emosional cinta, jarak, dan pertumbuhan pribadi.",
...
Um, trying to think of the right thing to say`,
      audio: "../assets/audioPassionfruit.mp3"
    },
    {
      id: 10,
      name: "All of Me",
      image:"../assets/allofme.jpeg",
      artist: "John Legend",
      description: "Lagu ini menggambarkan cinta yang sempurna dan tanpa syarat, dengan segala kelebihan dan kekurangan pasangan.",
...
And you give me all of you, oh-oh`,
      audio: "../assets/audioAllOfMe.mp3"
    },
    {
      id: 11,
      name: "Kill Bill",
      image:"../assets/killbill.jpeg",
      artist: "SZA",
      description: "Lagu ini menggambarkan sisi posesif dan emosional dari cinta yang sangat rumit.",
...
Rather be in Hell than alone`,
      audio: "../assets/audioKillBill.mp3"
    },
    {
      id: 12,
      name: "All the Stars",
      image:"../assets/allthestars.jpeg",
      artist: "Kendrick Lamar & SZA",
      description: "Lagu ini mengeksplorasi dinamika hubungan dan tantangan emosional dalam hidup.",
...
All the stars are closer
All the stars are closer`,
      audio: "../assets/audioAllTheStar.mp3"
    },
    {
      id: 13,
      name: "Super Shy",
      image:"../assets/supershy.jpeg",
      artist: "New Jeans",
      description: "Lagu ini menceritakan rasa grogi dan malu saat menyukai seseorang.",
...
Do you? (But I'm super shy, I'm super shy)`,
      audio: "../assets/audioSuperShy.mp3"
    },
    {
      id: 14,
      name: "SHEESH",
      image:"../assets/sheesh.jpeg",
      artist: "BABYMONSTER",
      description: "Lagu ini menunjukkan aura fierce dan confident dari BABYMONSTER dan Liriknya penuh kepercayaan diri .",
      lyrics: `Da-la-lun-dun
Da-la-lun-dun
Da-la-lun-dun
Baby, I'ma monster
...
Watch out, we on a roll
Rum, pump, pump, pump it up then`,
      audio: "../assets/audioSheesh.mp3"
    },
    {
      id: 15,
      name: "DICE",
      image:"../assets/dice.jpeg",
      artist: "NMIXX",
      description: "Lagu ini menceritakan tentang petualangan seru melawan tantangan demi cinta.",
...
Let's roll the dice`,
      audio: "../assets/audioDice.mp3"
    },
    {
      id: 16,
      name: "Magnetic",
      image:"../assets/magnetic.jpeg",
      artist: "ILLIT",
      description: "Lagu ini menggambarkan perasaan tertarik secara alami kepada seseorang seperti magnet.",
      lyrics: `Baby, I'm just trying to play it cool
...
Bae, bae, bae, bae, bae, bae, bae, bae, bae
Dash-da-da, dash-da-da, baby, don't say no`,
      audio: "../assets/audioMagnetic.mp3"
    },
    {
      id: 17,
      name: "Christmas Tree",
      image:"../assets/christmasttree.jpeg",
      artist: "V",
      description: "Lagu ini adalah OST drama korea 'Our Beloved Summer' yang menceritakan tentang perasaan cinta yang dalam dan kerinduan terhadap seseorang yang spesial.",
...
I'm falling for your eyes
I just want to be where you are`,
      audio: "../assets/audioChristmasTree.mp3"
    },
    {
      id: 18,
      name: "Armageddon",
      image:"../assets/armageddon.jpeg",
      artist: "AESPA",
      description: "Lagu ini menggambarkan kekacauan yang mereka taklukkan untuk membangun dunia baru.",
      lyrics: `Armageddon (shoot)
I'ma get 'em (shoot)
...
깊어가 혼란스러운 밤
악몽은 또 짙게 번져가
뭔갈 숨기려고 해 (ooh), I got it, I got it
...
이젠 널 끝내 better run (끝을 모르는 너와 나, you gonna, gonna, uh)
...
우릴 막지 마 (ah), we never play nice (shoot, uh)
완벽한 pair, 넌 똑같은 soul
...
(Ah) born like a queen, born like a king, yah (mmm, yeah)
Throw it back, throw it back, throw it back
(Uh-huh) 불러
...
끝과 시작의 Armageddon`,
      audio: "../assets/audioArmageddon.mp3"
    },
